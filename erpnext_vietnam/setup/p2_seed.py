...
def seed_p2_reference_data():
    instruments = [
        ...
        ("74/2025/QH15", "Luật Việc làm", "Quốc hội", "2025-06-16", "2026-01-01", "https://vanban.chinhphu.vn/", None),
        ("374/2025/NĐ-CP", "Quy định chi tiết một số điều của Luật Việc làm về bảo hiểm thất nghiệp", "Chính phủ", "2025-12-31", "2026-01-01", "https://vanban.chinhphu.vn/", None),
