...
def _evidence_snapshot(payload: dict) -> dict:
    excluded = {"adapter_ready", "review_required", "scope_note", "schema_version", "form_code"}
...
def preview_tax_declaration(company: str, declaration_type: str, from_date, to_date, period_type: str):
...
@frappe.whitelist()
def get_tax_declaration_preview(company: str, declaration_type: str, from_date, to_date, period_type: str):
    if not frappe.has_permission("Company", ptype="read"):
        frappe.throw("Not permitted to read Company data", frappe.PermissionError)
    return preview_tax_declaration(company, declaration_type, from_date, to_date, period_type)


@frappe.whitelist()
def create_tax_declaration(company: str, declaration_type: str, from_date, to_date, period_type: str):
    preview = preview_tax_declaration(company, declaration_type, from_date, to_date, period_type)
...
def preview_social_insurance_export(export_type: str, company: str | None = None, employee: str | None = None, from_date=None, to_date=None, as_of_date=None):
...
@frappe.whitelist()
def get_social_insurance_export_preview(export_type: str, company: str | None = None, employee: str | None = None, from_date=None, to_date=None, as_of_date=None):
    return preview_social_insurance_export(export_type, company, employee, from_date, to_date, as_of_date)


@frappe.whitelist()
def create_social_insurance_export(export_type: str, company: str | None = None, employee: str | None = None, from_date=None, to_date=None, as_of_date=None):
    preview = preview_social_insurance_export(export_type, company, employee, from_date, to_date, as_of_date)
    existing = frappe.db.get_value(
