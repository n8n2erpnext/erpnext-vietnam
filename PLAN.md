...
- [P4E next] Add production-adapter admission/certification pins so no adapter can run in PRODUCTION unless its official technical contract/schema artifacts are versioned and hash-pinned.
